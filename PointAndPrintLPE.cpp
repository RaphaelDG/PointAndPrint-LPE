...
int main()
{
    ...
    //std::cout << "\nFirst driver infos:\n";
    //std::cout << "pName : " << pInfo->pName << "\n";
    //std::cout << "pEnvironment : " << pInfo->pEnvironment << "\n";
    //std::cout << "pConfigFile : " << pInfo->pConfigFile << "\n";
    //std::cout << "pDriverPath : " << pInfo->pDriverPath << "\n";
    //std::cout << "cVersion : " << pInfo->cVersion << "\n";
    //std::cout << "cVersion : " << pInfo->pDataFile << "\n";
    ...
    for (DWORD i = 0; i < dwReturned; i++)
    {
	   ...
	   // if (wcsstr(pInfo[i].pDriverPath, L"ntprint.inf_amd64")) {
    ...
    badDriver.pName = const_cast < LPTSTR>("CACIB ASA Magic Driver");
